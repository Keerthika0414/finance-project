...
export declare type Cookies = cookies;
export declare type CallbackReturnType = [Error | null, boolean];
export declare type RequestCallback = (req: Request, res: Response, cookies: Cookies) => CallbackReturnType | undefined;
